...
function Dashboard() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-r from-gray-900 via-gray-800 to-black py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-3xl mx-auto bg-gray-900 rounded-xl shadow-2xl p-8">
        <div className="text-center">
          <ShieldCheck className="mx-auto h-16 w-16 text-teal-400" />
          <h1 className="mt-6 text-4xl font-extrabold text-white">Welcome to the Dashboard</h1>
